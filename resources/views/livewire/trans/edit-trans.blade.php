                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form wire:submit="update" class="mt-6 space-y-6">
                        <div>
                            ...
                            <x-text-input wire:model="tgl" id="tgl" name="tgl" type="date" class="mt-1 block w-full" autocomplete="off" value="{{$trans->tgl}}"/>
                        ...
                        <div>
                            ...
                            <select wire:model="id_barang" class="mt-1 block w-full">
                                ...
                                @foreach (\App\Models\Product::all() as $product)
                                    <option value="{{ $product->id }}" <?php echo $product->id == $trans->id_barang ? "selected" : ""?> >{{ $product->nama }}</option>
                                @endforeach
                            </select>
                        ...
                        <div>
                            ...
                            <x-text-input wire:model="jml" id="jml" name="jml" type="text" class="mt-1 block w-full" autocomplete="off" value="{{$trans->jml}}"/>
